...
_(Bring your own [Groq API key](https://console.groq.com) — free, no credit card needed)_
...
**Semantic intent classification** — Using an LLM to understand _what a user is trying to do_, rather than just what words they used. "Tell me a funny story" and "make me laugh" have different words but the same intent.
